...
import {IAppForm, IUserDataForm, IOrderPerson, OrderFormErrors, IUserContactsForm } from '../types';


export class Contacts extends Model<IAppForm> {
	...
	setContactsField(field: keyof IUserContactsForm, value: string) {
	...
	setAddressField(field: keyof IUserDataForm, value: string) {
		this.orderPerson[field] = value;
